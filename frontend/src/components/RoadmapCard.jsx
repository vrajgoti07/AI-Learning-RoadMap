...
import { ChevronDown, ChevronUp, BookOpen, Layout } from 'lucide-react';

export default function RoadmapCard({ phase, title, duration, description, projects, milestones, index }) {
